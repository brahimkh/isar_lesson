...
extension StudentCollectionQuerySortBy
  ...
  QueryBuilder<StudentCollection, StudentCollection, QAfterSortBy> sortByAge() {
    return QueryBuilder.apply(this, (query) {
...
extension StudentCollectionQuerySortThenBy
  ...
  QueryBuilder<StudentCollection, StudentCollection, QAfterSortBy> thenByAge() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'age', Sort.asc);
    });
  }
...
extension StudentCollectionQueryProperty
  ...
  QueryBuilder<StudentCollection, int?, QQueryOperations> ageProperty() {
    return QueryBuilder.apply(this, (query) {
